class Api::V1::Web::PayrollManagement::CustomTaxSlabsController < ApplicationController
	...
	before_filter :set_custom_tax_slab, :only => [:show, :update, :destroy]
  ...
  def index
    ...
    render status:200, template: 'api/v1/web/payroll_management/custom_tax_slabs/index.json.jbuilder'
  end
  ...
  def show
    render status:200, template: 'api/v1/web/payroll_management/custom_tax_slabs/show.json.jbuilder'
  end
