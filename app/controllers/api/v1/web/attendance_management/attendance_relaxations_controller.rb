class Api::V1::Web::AttendanceManagement::AttendanceRelaxationsController < ApplicationController
	...
	before_filter :set_attendance_relaxation, :only => [:show, :update, :destroy]
  ...
  def index
    ...
    render status:200, template: 'api/v1/web/attendance_management/attendance_relaxations/index.json.jbuilder'
  end
  ...
  def show
    render status:200, template: 'api/v1/web/attendance_management/attendance_relaxations/show.json.jbuilder'
  end
