class CreateAttendanceMachineLogs < ActiveRecord::Migration[7.1]
  def change
    create_table :attendance_machine_logs do |t|
    ...
    add_index :attendance_machine_logs, :company_id
    add_index :attendance_machine_logs, :employee_id
  end
end
